class Event < ActiveRecord::Base
  ...
  scope :between, proc {|range_start, range_end|
  ...
  def self.find_by(params)
    ...
    query = week_of(params[:week]) if params[:week]
    query = between(params[:starts_at], params[:ends_at]) if params[:starts_at] and params[:ends_at]
    query = with_tags(params[:tags]) if params[:tags]
  ...
  def to_html_attributes
    {
      ...
      "data-starts-at"      => starts_at.blank? ? nil : starts_at,
      "data-starts-at-time" => starts_at_time,
      "data-starts-at-date" => starts_at_date.to_s, 
      "data-ends-at"        => ends_at.blank? ? nil : ends_at, 
